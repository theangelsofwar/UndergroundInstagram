...
import SpotLightsCarousael from '../../../assets/theme/components/SpotLightsCarousel';
import DefaultButton from '../../../assets/theme/components/DefaultButton';
import MediaGrid from '../../../assets/theme/components/MediaGrid';
import TabBar from '../../../assts/theme/components/TabBar';
    ...
    <ScrollView showVerticalScrollIndicator={false}>
      <View style={styles.containerFluid}>
        ...
        <View style={styles.defaultViewBox}>
          <Text style={styles.mediumBoldText}> Yve Vestal</Text>
        ...
        <View style={styles.defaultViewBox}>
          <SpotLightsCarousael data={profileSpotLights} addSpotlightText-{t(`app:new`)}/>
        </View>
      </View>

      <TabView
      navigationState={nagivationState}
